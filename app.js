...
//"async function" porque vai ter "await" lá no meio da requisição HTTP (profile.html)
...
document.querySelector("form").addEventListener("submit", async function (e) {
    ...
    try {
        ...
        if (resposta.status === "ok") { // se o servidor mandou status: "ok"
            if (isLogin) { // guarda os dados do usuário no localStorage e redireciona pra página profile
